  ...
  useEffect(
    () => {
      const newHospitalsInfo = hospitalResult?.find(
        (hospitalSearchedFor) => hospitalSearchedFor.fsq_id === hospitalId
      );
      console.log(newHospitalsInfo);
    ...
    [hospitalId, hospitalDetails, hospitalResult]
  );
      ...
      <div className="hospital-landing-page-container">
        ...
        <div className="single-hospital-landing-page-details">
          ...
          <div className="single-hospital-landing-page-department-images">
            <img
              src={DepartmentImage1}
              alt={"image showing a department in the hospital"}
              className="department-image"
            />
            <img
              src={DepartmentImage2}
              alt={"image showing a department in the hospital"}
              className="department-image"
            />
            <img
              src={DepartmentImage3}
              alt={"image showing a department in the hospital"}
              className="department-image"
            />
          </div>

          <div className="hospitals-image"></div>
        </div>
        ...
        <div className="hospital-department">
          <div className="hospital-active-departmments-intro">
            ...
            <p>
              Check out some of our functioning departments at{" "}
          ...
          <div className="active-department-images">
            <img
              src={ActiveDepartmentImage}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
            <img
              src={ActiveDepartmentImage1}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
            <img
              src={ActiveDepartmentImage2}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
            <img
              src={ActiveDepartmentImage3}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
            <img
              src={ActiveDepartmentImage4}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
            <img
              src={ActiveDepartmentImage5}
              alt={"image showing active department in the hospital"}
              className="active-department-image"
            />
          </div>
        ...
        <span className="arrow-back-container">
          <Link
            ...
            title="Take me back to the previous page"
          >
            &larr;
          </Link>
        </span>
